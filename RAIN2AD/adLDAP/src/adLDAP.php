...
class adLDAP {
    ...
    * @var string
    */
	protected $accountSuffix = "@gswcm.local";
    ...
    * @var string
    */
	protected $baseDn = "DC=gswcm,DC=local";
    ...
    * @var array
    */
    protected $domainControllers = array("dc.gswcm.local");
    ...
    */
    ...
    protected $adminPassword = "I'veGotTheFeeling51";
